...
public class TrackerMessager implements IMessageProcess {

	public final static String LOG_TAG = "TrackerMessager";
	
	public final static String SENT = "SMS_SENT";
    public final static String DELIVERED = "SMS_DELIVERED";
	
	private ISettings settings;
	private IMessageProcess messageSettings;
	...
	public Message SentInit(Activity startActivity) {
		settings = HunterDogActivity.currSettings;
		messageSettings = HunterDogActivity.iMessager;
		...
		message.messageText = messageSettings.getBeginFormat(startActivity.getResources().getString(R.string.mBegin));
	...
	public void SentSetting(Activity map) {
		...
		message.messageText = String.format(messageSettings.getSettingFormat(), time + period);
	...
	private void ReceiveCoords(String sms) {
		sms = sms.replace(": ", ":");
		String[] smsVals = messageSettings.splitCoordsMsg(sms);
	...
	public String getSettingFormat() {
		Log.i(LOG_TAG, "Unimplemented method 'getSettingFormat'");
		throw new UnknownError();
	}
	
	@Override
	public String getBeginFormat(String fake) {
		Log.i(LOG_TAG, "Unimplemented method 'getInitFormat'");
		throw new UnknownError();
	}
}
